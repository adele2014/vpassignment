...
using VPToDoTask.Application.Features.Todos.Commands.CreateTodo;
using VPToDoTask.Application.Features.Todos.Commands.DeleteTodoById;
using VPToDoTask.Application.Features.Todos.Commands.UpdateTodo;
using VPToDoTask.Application.Features.Todos.Queries.GetTodoById;
using VPToDoTask.Application.Features.Todos.Queries.GetTodos;
using VPToDoTask.WebApi.Extensions;

// For more information on enabling Web API for empty projects, visit https://go.microsoft.com/fwlink/?LinkID=397860

namespace VPToDoTask.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
    public class TodosController : BaseApiController
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] GetTodosQuery filter)
        {
        ...
        /// <summary>
        /// Sends an InsertMockTodoCommand to the mediator.
        /// </summary>
        ...
        [Route("AddMock")]
        //[Authorize]
        public async Task<IActionResult> AddMock(InsertMockTodoCommand command)
        {
        ...
        //[Authorize]
        [Route("Paged")]
        public async Task<IActionResult> Paged(PagedTodosQuery query)
        {
