...
using VPToDoTask.Infrastructure.Persistence.Repositories;
using VPToDoTask.Infrastructure.Persistence.Repository;

namespace VPToDoTask.Infrastructure.Persistence
{
    public static class ServiceRegistration
    {
        public static void AddPersistenceInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<ITodoRepositoryAsync, TodoRepositoryAsync>();
